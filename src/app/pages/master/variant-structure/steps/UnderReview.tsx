  ...
  return (
    <div className="h-full text-center">
      ...
      <p className="mx-auto mt-2 max-w-(--breakpoint-lg) text-balance sm:px-5">
        Thank you for submitting the form. We have received your data
        and we will verify it as soon as possible. If you have any questions or
        concerns, please contact us at support@autobook.com
      </p>
      <Button
        color="primary"
        className="mt-8 w-full px-10 sm:w-auto"
        to="/master/variant-structure"
        component={Link}
      >
        Go To Variant Structure
      </Button>
    </div>
  );
}

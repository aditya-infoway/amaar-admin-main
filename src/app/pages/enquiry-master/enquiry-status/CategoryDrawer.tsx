...
interface EnquiryStatusDrawerProps {
  isOpen: boolean;
  close: () => void;
  enquiryStatus: EnquiryStatus | null;
  onSave: (enquiryStatus: EnquiryStatus) => void;
}

export function EnquiryStatusDrawer({
  isOpen,
  close,
  enquiryStatus,
  onSave,
        ...
        >
          ...
          <div className="flex items-center justify-between border-b border-gray-200 px-4 py-4 dark:border-dark-500 sm:px-5 bg-primary">
            <h3 className="text-lg font-semibold text-white">
              {isEdit ? "Edit Enquiry Status" : "Create Enquiry Status"}
            </h3>
            <Button
              onClick={handleClose}
              variant="flat"

...
interface EnquirySourceDrawerProps {
  isOpen: boolean;
  close: () => void;
  enquirySource: EnquirySource | null;
  onSave: (enquirySource: EnquirySource) => void;
}

export function EnquirySourceDrawer({
  isOpen,
  close,
  enquirySource,
  onSave,
        ...
        >
          ...
          <div className="flex items-center justify-between border-b border-gray-200 px-4 py-4 dark:border-dark-500 sm:px-5 bg-primary">
            <h3 className="text-lg font-semibold text-white">
              {isEdit ? "Edit Enquiry Source" : "Create Enquiry Source"}
            </h3>
            <Button
              onClick={handleClose}
              variant="flat"

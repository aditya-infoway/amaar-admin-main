...
export default function EnquirySourcePage() {
  ...
  const persist = (next: EnquirySource[]) => {
    setData(next);
    masterStorage.saveEnquirySources(next);
  };
    ...
    <Page title="Enquiry Source">
      <div className="transition-content w-full pb-5">
        ...
        <MasterTable
          ...
          emptyMessage="No enquiry sources found. Click Create Enquiry Source to add one."
        />
      </div>

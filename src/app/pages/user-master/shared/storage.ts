...
const KEYS = {
  ...
  employees: "amaar_master_employees",
  finances: "amaar_master_finances",
  accounts: "amaar_master_accounts",
} as const;
...
export const masterStorage = {
  ...
  saveEmployees: (data: Employee[]) => write(KEYS.employees, data),
  ...
  saveAccounts: (data: Account[]) => write(KEYS.accounts, data),
